...
class MysqlStatsd():
    ...
    def __init__(self):
        ...
        self.daemonize('/dev/null',self.config.get('daemon').get('logfile','/bigdisk/logs/mysql_statsd/daemon.log'),self.config.get('daemon').get('logfile','/bigdisk/logs/mysql_statsd/daemon.log'))
